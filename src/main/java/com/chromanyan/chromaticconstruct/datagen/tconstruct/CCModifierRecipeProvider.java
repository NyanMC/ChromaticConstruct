...
public class CCModifierRecipeProvider extends CCBaseRecipeProvider {
    ...
    private void addModifierRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ModifierRecipeBuilder.modifier(CCModifierIds.heartstopper)
                ...
                .setSlots(SlotType.UPGRADE, 1)
                .setMaxLevel(3)
                .saveSalvage(consumer, prefix(CCModifierIds.heartstopper, upgradeSalvage))
                .save(consumer, prefix(CCModifierIds.heartstopper, upgradeFolder));
